...
public class Introduccion : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /*print(AtaquesPlayer(3, 5));

        for (int i = 0; i < numAtaques; i++)
        {
            Ataque();
        }
        Debug.Log("El numero total de ataques ha sido: " + numAtaques);
        Debug.Log("El daño generado ha sido : " + damage);*/
    }
    /*void Ataque()
    {
        int damageFunction = 10;
        damage = damage + damageFunction;
    }*/

    /*string AtaquesPlayer(int cantidadAtaques, int danoAtaque)
    {
        int danoAtaqueTotal;
        danoAtaqueTotal = danoAtaque * cantidadAtaques;

        return "Combo de " + cantidadAtaques + " ataques" + "\n" +  "Daño total = " + danoAtaqueTotal;
    }*/
